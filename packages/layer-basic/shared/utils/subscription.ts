...
import { BillingCycle, SubscriptionPlan } from '../types/db'
import type { BillingCycleType, SubscriptionPlanType } from '../types/db'
...
export type StatsAccessType = (typeof StatsAccess)[keyof typeof StatsAccess]

export interface PlanLimits {
  wallets: number
  strategies: number
  bots: number
  maxBuySize: number | null // null = unlimited
  statsAccess: StatsAccessType
}
...
export const SUBSCRIPTION_PLANS: Record<SubscriptionPlanType, PlanDefinition> = {
  ...
  [SubscriptionPlan.PRO]: {
    ...
    limits: {
      ...
      bots: 20,
      maxBuySize: 40,
      statsAccess: StatsAccess.PARTIAL,
    },
  },
  [SubscriptionPlan.PLUS]: {
    name: 'Plus',
    ...
    limits: {
      ...
      bots: 100,
      maxBuySize: 200,
      statsAccess: StatsAccess.EXTENDED,
    },
  },
  [SubscriptionPlan.MAX]: {
    name: 'Max',
    ...
    limits: {
      ...
      strategies: 1000,
      bots: 1000,
      maxBuySize: null, // Unlimited
      statsAccess: StatsAccess.FULL,
    },
  },
}
