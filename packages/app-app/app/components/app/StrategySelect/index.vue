...
import type { LoadMethodParams, LoadMethodResult, SelectOption } from '@packages/layer-basic/app/components/ui/SearchSelect/index.vue'
  ...
  >
    <template #value="{ option }">
      <div class="flex min-w-0 items-center gap-1">
        ...
        >
          ({{ option.meta.maxBuySize }} · {{ formatCurrency(option.meta.amount) }})
        </span>
      </div>
    </template>
