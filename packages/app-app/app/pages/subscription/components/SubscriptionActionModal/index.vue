...
const T = useTranslations('pages.subscription.components.SubscriptionActionModal')
const TPage = useTranslations('pages.subscription')
...
const action = computed<SubscriptionAction>(() => {
  if (props.currentPlanId === props.targetPlanId) return 'renew'
  return getPlanIndex(props.targetPlanId) > getPlanIndex(props.currentPlanId) ? 'upgrade' : 'downgrade'
})
