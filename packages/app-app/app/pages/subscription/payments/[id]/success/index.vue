...
definePageMeta({
  layout: 'auth',
  title: 'pages.subscription.payments._id_.success.name',
})

const T = useTranslations('pages.subscription.payments._id_.success')
...
async function startPolling () {
  ...
  if (isConfirmed.value) {
    request.invalidateCache('/api/subscription')
    fetchSubscription()
  }
}
