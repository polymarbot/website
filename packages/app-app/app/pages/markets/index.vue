...
const filteredMarkets = computed(() => {
  ...
  const filterSymbols = filters.symbols
    ? filters.symbols.split(',') as MarketSymbolType[]
    : allSymbols
  const filterIntervals = filters.intervals
    ? filters.intervals.split(',') as MarketIntervalType[]
    : allIntervals
