...
const T = useTranslations('pages.rankings.components.StrategyDetailModal')
...
function handleConfirm () {
  ...
  if (existingStrategyId.value) {
    navigateTo(`/strategies/${existingStrategyId.value}`)
  } else {
    navigateTo(`/strategies/new?marketStrategyId=${props.strategy.strategyId}`)
  }
}
