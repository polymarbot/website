...
const T = useTranslations('pages.strategies._id_.components.TradeStepCard')
      ...
      <div class="flex flex-col gap-2 text-sm leading-6">
        ...
        <template v-if="isBuyStep">
          ...
          >
            ...
            <span class="font-medium">
              {{ formatDecimal((step as TradeStepBuy).maxUnderlyingChange! / 100, 2) }}%
            </span>
          </div>
          ...
          >
            ...
            <span class="font-medium">
              {{ formatDecimal((step as TradeStepBuy).minUnderlyingChange! / 100, 2) }}%
            </span>
          </div>
