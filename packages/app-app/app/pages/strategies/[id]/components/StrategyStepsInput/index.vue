...
const T = useTranslations('pages.strategies._id_.components.StrategyStepsInput')
...
// Buy size validation
const buySizeTooHigh = computed(() => steps.value.length > 0 && props.maxBuySize != null && totalBuySize.value > props.maxBuySize)
...
<template>
  <div class="flex flex-col gap-4">
    ...
    <Message
      ...
      severity="warn"
    >
      {{ T('warnings.buySizeTooHigh', { maximum: maxBuySize! }) }}
    </Message>
