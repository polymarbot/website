...
export default defineWrappedResponseHandler(async event => {
  ...
  // Invalidate internal bots cache for affected intervals
  const disabledIntervals = enabledBots.map(b => b.interval)
  await invalidateBotsCacheByIntervals(disabledIntervals)
